...
logging.basicConfig(filename='image_organizer.log', level=logging.DEBUG, format='%(asctime)s - %(levelname)s - %(message)s')
from ui import UI
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.ui.progress_text.textChanged.connect(self.print_to_terminal)
        self.uploaded_images = []

    def print_to_terminal(self):
        print(self.ui.progress_text.toPlainText())
